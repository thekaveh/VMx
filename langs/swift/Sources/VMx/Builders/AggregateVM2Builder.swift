//
// AggregateVM2Builder<C1, C2> — immutable fluent builder.
//
import Foundation

public struct AggregateVM2Builder<C1: ComponentVMBase, C2: ComponentVMBase> {
    ...
    public func build() throws -> AggregateVM2<C1, C2> {
