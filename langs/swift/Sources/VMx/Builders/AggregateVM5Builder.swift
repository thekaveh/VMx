//
// AggregateVM5Builder<C1..C5> — immutable fluent builder.
//
import Foundation

public struct AggregateVM5Builder<
...
> {
    ...
    public func build() throws -> AggregateVM5<C1, C2, C3, C4, C5> {
        ...
        return AggregateVM5<C1, C2, C3, C4, C5>(
            name: name, hint: _hint,
            hub: hub, dispatcher: dispatcher,
            factory1: f1, factory2: f2, factory3: f3, factory4: f4, factory5: f5
        )
    }
}
