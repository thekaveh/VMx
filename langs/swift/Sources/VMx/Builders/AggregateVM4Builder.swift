//
// AggregateVM4Builder<C1..C4> — immutable fluent builder.
//
import Foundation

public struct AggregateVM4Builder<
...
> {
    ...
    public func build() throws -> AggregateVM4<C1, C2, C3, C4> {
        ...
        return AggregateVM4<C1, C2, C3, C4>(
            name: name, hint: _hint,
            hub: hub, dispatcher: dispatcher,
            factory1: f1, factory2: f2, factory3: f3, factory4: f4
        )
    }
}
