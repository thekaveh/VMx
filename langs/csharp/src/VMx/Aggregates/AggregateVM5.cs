    ...
    where VM5 : class, IComponentVM
{
    ...
    protected override void OnConstruct()
    {
        ...
        Hub.Send(PropertyChangedMessage<AggregateVM5<VM1, VM2, VM3, VM4, VM5>>.Create(this, Name, nameof(Component1)));

        _component2 = _factory2();
        RaisePropertyChanged(nameof(Component2));
        Hub.Send(PropertyChangedMessage<AggregateVM5<VM1, VM2, VM3, VM4, VM5>>.Create(this, Name, nameof(Component2)));

        _component3 = _factory3();
        RaisePropertyChanged(nameof(Component3));
        Hub.Send(PropertyChangedMessage<AggregateVM5<VM1, VM2, VM3, VM4, VM5>>.Create(this, Name, nameof(Component3)));

        _component4 = _factory4();
        RaisePropertyChanged(nameof(Component4));
        Hub.Send(PropertyChangedMessage<AggregateVM5<VM1, VM2, VM3, VM4, VM5>>.Create(this, Name, nameof(Component4)));

        _component5 = _factory5();
        RaisePropertyChanged(nameof(Component5));
        Hub.Send(PropertyChangedMessage<AggregateVM5<VM1, VM2, VM3, VM4, VM5>>.Create(this, Name, nameof(Component5)));
