...
/// <summary>
/// Arity-3 aggregate viewmodel interface.
/// Exposes three typed component slots populated on construct().
...
public interface IAggregateVM3<out VM1, out VM2, out VM3> : IComponentVM
