...
The source tree currently implements v3.11.0. The scoped npm package has not
...
The minimum-viable shape is `imports → services → builder (name + model + services + optional modeledHinter) → construct() → read status`:
