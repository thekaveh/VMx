...
- **`spec/` is the source of truth.** 24 numbered markdown chapters (`00-overview.md` … `23-async-resource-vm.md`), 122 ADRs, four JSON fixtures, supporting schemas, current version in `spec/VERSION` (3.22.0). Behavior changes start here.
