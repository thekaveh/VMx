...
- **`spec/` is the source of truth.** 24 numbered markdown chapters (`00-overview.md` … `23-async-resource-vm.md`), 104 ADRs, four JSON fixtures, supporting schemas, current version in `spec/VERSION` (3.20.0). Behavior changes start here.
