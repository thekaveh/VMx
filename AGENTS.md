...
- **`spec/` is the source of truth.** 23 numbered markdown chapters (`00-overview.md` … `22-discriminator-vm.md`), 78 ADRs, four JSON fixtures, current version in `spec/VERSION` (3.1.0). Behavior changes start here.
