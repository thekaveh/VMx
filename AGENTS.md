...
- **`spec/` is the source of truth.** 24 numbered markdown chapters (`00-overview.md` … `23-async-resource-vm.md`), 100 ADRs, four JSON fixtures, current version in `spec/VERSION` (3.20.0). Behavior changes start here.
