...
> The Rust flavor is a source-tree flavor at the v3.22.1 source line: it declares
> `MIN_SPEC_VERSION = "3.22.1"` and carries behavioral tests for all 399 library
