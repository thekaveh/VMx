...
This gallery maps every committed VMx example app. Each diagram depicts the
same three elements: the host and adapter boundary, the VMx-owned application
state, and the verification/modeling rule.

## 8.2.1. C\#

### 8.2.1.1. C# Console HelloVMx

<img src="../../assets/diagrams/csharp-console-hello-vmx.svg" alt="C# Console HelloVMx Example" class="vmx-diagram" />
...
### 8.2.1.2. C# WPF Todo App

<img src="../../assets/diagrams/csharp-wpf-todo-app.svg" alt="C# WPF Todo App Example" class="vmx-diagram" />
...
### 8.2.1.3. C# Avalonia Notes Showcase

<img src="../../assets/diagrams/csharp-avalonia-notes-showcase.svg" alt="C# Avalonia Notes Showcase Example" class="vmx-diagram" />
...
### 8.2.2.1. Python Console hello_vmx

<img src="../../assets/diagrams/python-console-hello-vmx.svg" alt="Python Console hello_vmx Example" class="vmx-diagram" />
...
### 8.2.2.2. Python tkinter Todo App

<img src="../../assets/diagrams/python-tk-todo-app.svg" alt="Python tkinter Todo App Example" class="vmx-diagram" />
...
### 8.2.2.3. Python Textual Inspector

<img src="../../assets/diagrams/python-textual-inspector.svg" alt="Python Textual Inspector Example" class="vmx-diagram" />
...
### 8.2.2.4. Python Textual Notes Showcase

<img src="../../assets/diagrams/python-textual-notes-showcase.svg" alt="Python Textual Notes Showcase Example" class="vmx-diagram" />
...
### 8.2.3.1. TypeScript Console hello-vmx

<img src="../../assets/diagrams/typescript-console-hello-vmx.svg" alt="TypeScript Console hello-vmx Example" class="vmx-diagram" />
...
### 8.2.3.2. TypeScript React Notes Showcase

<img src="../../assets/diagrams/typescript-react-notes-showcase.svg" alt="TypeScript React Notes Showcase Example" class="vmx-diagram" />
...
### 8.2.4.1. Swift Notes Showcase

<img src="../../assets/diagrams/swift-notes-showcase.svg" alt="Swift Notes Showcase Example" class="vmx-diagram" />
...
### 8.2.5.1. Rust Console hello-vmx

<img src="../../assets/diagrams/rust-console-hello-vmx.svg" alt="Rust Console hello-vmx Example" class="vmx-diagram" />
...
### 8.2.5.2. Rust TUI Notes Showcase
