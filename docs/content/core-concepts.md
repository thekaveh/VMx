...
The spec defines 408 conformance IDs: 403 library IDs plus 5 `THEME-00x`
scenario IDs. Every catalog-complete flavor carries the 403 library IDs in its own
