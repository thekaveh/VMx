...
VMx has five full-parity source flavors. The source tree implements v3.1.0 for
C#, Python, TypeScript, and Swift; Rust declares `MIN_SPEC_VERSION = "3.1.0"`
from crate version 0.1.0. Public package availability can lag the source tree;
...
| Rust       | 0.1.0         | crates.io package not published yet |
