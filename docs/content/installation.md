...
v3.22.1; TypeScript 3.23.1 implements spec 3.22.1, and Rust 0.25.1
declares `MIN_SPEC_VERSION = "3.22.1"`. “Catalog-complete” means all 399 library
...
| Swift      | v3.22.1       | SwiftPM release 3.20.0              |
| Rust       | 0.25.1        | crates.io package not published yet |
