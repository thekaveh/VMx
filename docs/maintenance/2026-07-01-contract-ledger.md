...
| ------------------ | --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| C# runtime         | `langs/csharp/Directory.Packages.props`; project lockfiles      | `System.Reactive` and `Microsoft.Reactive.Testing` are `7.0.0`, with `System.Collections.Immutable` `10.0.10`; the library targets `netstandard2.0;net8.0`; both test suites execute on `net8.0;net9.0;net10.0`. Production-package Cobertura coverage cannot fall below 70% lines or 62% branches; test assemblies are excluded.                   | `dotnet restore VMx.sln --locked-mode`; Release build/test with coverage; `tools/check-cobertura-threshold.py`; `dotnet format --verify-no-changes --no-restore`   |
