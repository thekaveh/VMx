...
- Flavor README:
  [langs/csharp/README.md](https://github.com/thekaveh/VMx/blob/main/langs/csharp/README.md)
- Getting started guide:
  [docs/getting-started/csharp.md](https://github.com/thekaveh/VMx/blob/main/docs/getting-started/csharp.md)
- Example portfolio:
  [Examples overview](../examples/index.md)
- Flagship Notes Workspace:
  [Notes Workspace](../examples/notes-workspace.md)
- Avalonia recipe:
  [docs/integration/avalonia.md](https://github.com/thekaveh/VMx/blob/main/docs/integration/avalonia.md)
