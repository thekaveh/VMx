...
C#, Python, TypeScript, and Swift. The conceptual shape stays aligned; naming,
package workflow, and host integration follow the local language.
...
- All four full-parity flavors target the same VM family model, lifecycle
  semantics, and conformance catalog.
- Public naming follows ADR-0006: PascalCase in C#, snake_case in Python,
  camelCase in TypeScript and Swift.
...
the repository:
[C#](https://github.com/thekaveh/VMx/blob/main/langs/csharp/README.md),
[Python](https://github.com/thekaveh/VMx/blob/main/langs/python/README.md),
[TypeScript](https://github.com/thekaveh/VMx/blob/main/langs/typescript/README.md),
[Swift](https://github.com/thekaveh/VMx/blob/main/langs/swift/README.md).
