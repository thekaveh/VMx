...
def hierarchical_family() -> Diagram:
    return Diagram(
        ...
        subtitle="recursive ownership, key-aware batch hydration, and parent/depth/path invariants",
        width=1720,
        height=1040,
        boundaries=(
        ...
        notes=(
            Note(
                ...
                "Decision rule",
                (
                    "Use HierarchicalVM when recursive structure is part of the VM contract; attachMany centralizes streamed-tree ordering, dedupe, and orphan policy.",
                ),
                "#a78bfa",
            ),
        ),
    ...
    return Diagram(
        ...
        boxes=(
            Box(
                ...
                (
                    "CanExecute / Execute / CanExecuteChanged",
                    "parameterized variant when payload is needed",
                ),
                "bus",
            ),
            Box(
        ...
        lines=(
            Polyline(
                ((540, 229), (690, 229)),
                color="#34d399",
                label="commands call capability verbs",
                label_xy=(620, 213),
            ),
            Polyline(
                ((540, 381), (690, 381)),
                color="#34d399",
                label="bind UI affordances",
                label_xy=(620, 365),
            ),
            Polyline(
                ((540, 533), (690, 533)), color="#34d399", label="gate CRUD", label_xy=(604, 517)
            ),
            Polyline(
                ((540, 685), (690, 685), (690, 588)),
                color="#34d399",
                label="extra gate",
                label_xy=(616, 669),
            ),
