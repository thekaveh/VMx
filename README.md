...
- **Spec** — `spec/` is the source of truth: 22 markdown chapters, 51 ADRs,
...
│   ├── ADRs/              architecture decision records (0001..0051)
...
- [`compatibility-matrix.md`](compatibility-matrix.md) — spec ↔ flavor
  version pairing.
- [`spec/README.md`](spec/README.md) — index of the 22 chapters, 51 ADRs,
