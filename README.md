...
- **Spec** — `spec/` is the source of truth: 24 markdown chapters, 129 ADRs,
...
| Rust       | v0.28.0 in source | crates.io package not published yet                                                    | VMx-owned hot-stream facade |
...
| ------ | ------------- | ------------- | ------------- | -------------- | ------------- |
| 3.23.x | 3.23.0        | 3.23.0        | 3.24.0        | 3.24.0         | 0.28.0        |
...
│   ├── ADRs/              architecture decision records (0001..0129)
...
- [`compatibility-matrix.md`](compatibility-matrix.md) — spec ↔ flavor
  version pairing.
- [`spec/README.md`](spec/README.md) — index of the 24 chapters, 129 ADRs,
