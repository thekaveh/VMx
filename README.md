...
Swift / Rust). All five source flavors cover the 342 library conformance IDs;
the flagship example apps cover 5 additional THEME scenario IDs for **347
...
UI-backed flavors to **347 total** tracked scenarios. See
...
`spec/12-conformance.md` enumerates 347 normative test scenarios keyed by ID
(`LIFE-001`, `HUB-007`, `COMP-013`, `UTIL-002`, `CAP-020`, `DPROP-012`,
`NOTIF-010`, `DIA-001`, `FORM-001`, `COL-001`, `HIER-001`, `AGG-006`,
`THEME-001`, …) — 342 library IDs plus 5 `THEME` scenario IDs. All five
flavors (C# / Python / TypeScript / Swift / Rust) implement the 342 library IDs under
...
stable flavor is at **total parity: 342 library + 5 THEME = 347**.
