...
builder areas (39 conformance IDs as of 2.5.0 — recounted honestly in
ADR-0037). Full conformance parity with the other flavors lands in a
...
| [`VMx.Notifications`](https://www.nuget.org/packages/VMx.Notifications/)                      | 1.2.0   | 2.5.x |
