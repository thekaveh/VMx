...
children. In the reference implementations of all five active flavors their predicate
...
so `Parent.Current != this` holds for every group child. (All five active flavors add a
