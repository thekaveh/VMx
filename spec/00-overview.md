...
| **conformance ID** | a stable `XXX-NNN` identifier in `12-conformance.md`; all five library suites implement the 399 library IDs, while `THEME-00x` IDs apply to UI-backed flagship applications. |
