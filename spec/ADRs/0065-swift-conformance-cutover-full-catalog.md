...
- **Historical references.** ADRs 0053 and 0059–0064 reference `langs/swift/conformance-subset.txt` by name; those references are accurate as of when each was written and are left intact as point-in-time records. This ADR is the breadcrumb for the file's retirement.
