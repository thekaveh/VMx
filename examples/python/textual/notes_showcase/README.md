...
| 6   | `RelayCommand` + `AsyncRelayCommand` reactive            | `note_form_vm.approve_command` / `deny_command`; `note_vm.save_command` and the inner delete command await repository callbacks before success notification                                                                                                            |
